...
if __name__ == "__main__":
    ...
    while time.time()-t9 < 20:
        ...
        try:
            ...
            prev_error_y = angles['x'] # Temporary change

        error_y = angles['x'] # No subtraction as desired angle is 0, recently added negative 10 due to position error of IMU
